...
pub struct PduSessionResourceSetupRequest {
	...
	pub ue_slice_maximum_bit_rate_list: Option<UeSliceMaximumBitRateList>,
}
...
impl PduSessionResourceSetupRequest {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut ue_slice_maximum_bit_rate_list: Option<UeSliceMaximumBitRateList> = None;
		...
		Ok(Self {
			...
			ue_slice_maximum_bit_rate_list,
		})
	}
	fn encode_inner(
		&self,
...
pub struct InitialContextSetupRequest {
	...
	pub time_sync_assistance_info: Option<TimeSyncAssistanceInfo>,
	pub qmc_config_info: Option<QmcConfigInfo>,
	pub target_nssai_information: Option<TargetNssaiInformation>,
	pub ue_slice_maximum_bit_rate_list: Option<UeSliceMaximumBitRateList>,
	pub five_g_pro_se_authorized: Option<FiveGProSeAuthorized>,
	pub five_g_pro_se_ue_pc5_aggregate_maximum_bit_rate:
		Option<NrUeSidelinkAggregateMaximumBitrate>,
	pub five_g_pro_se_pc5_qos_parameters: Option<FiveGProSePc5QosParameters>,
}
...
impl InitialContextSetupRequest {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut time_sync_assistance_info: Option<TimeSyncAssistanceInfo> = None;
		let mut qmc_config_info: Option<QmcConfigInfo> = None;
		let mut target_nssai_information: Option<TargetNssaiInformation> = None;
		let mut ue_slice_maximum_bit_rate_list: Option<UeSliceMaximumBitRateList> = None;
		let mut five_g_pro_se_authorized: Option<FiveGProSeAuthorized> = None;
		let mut five_g_pro_se_ue_pc5_aggregate_maximum_bit_rate: Option<
			NrUeSidelinkAggregateMaximumBitrate,
		> = None;
		let mut five_g_pro_se_pc5_qos_parameters: Option<FiveGProSePc5QosParameters> = None;
		...
		for _ in 0..num_ies {
			...
			match id {
				...
				326 => time_sync_assistance_info = Some(TimeSyncAssistanceInfo::decode(data)?),
				328 => qmc_config_info = Some(QmcConfigInfo::decode(data)?),
				334 => target_nssai_information = Some(TargetNssaiInformation::decode(data)?),
				335 => {
					ue_slice_maximum_bit_rate_list = Some(UeSliceMaximumBitRateList::decode(data)?)
				}
				345 => five_g_pro_se_authorized = Some(FiveGProSeAuthorized::decode(data)?),
				346 => {
					five_g_pro_se_ue_pc5_aggregate_maximum_bit_rate =
						Some(NrUeSidelinkAggregateMaximumBitrate::decode(data)?)
				}
				347 => {
		...
		Ok(Self {
			...
			time_sync_assistance_info,
			qmc_config_info,
			target_nssai_information,
			ue_slice_maximum_bit_rate_list,
...
pub struct UeContextModificationRequest {
	...
	pub time_sync_assistance_info: Option<TimeSyncAssistanceInfo>,
	pub qmc_config_info: Option<QmcConfigInfo>,
	pub qmc_deactivation: Option<QmcDeactivation>,
	pub ue_slice_maximum_bit_rate_list: Option<UeSliceMaximumBitRateList>,
...
impl UeContextModificationRequest {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut time_sync_assistance_info: Option<TimeSyncAssistanceInfo> = None;
		let mut qmc_config_info: Option<QmcConfigInfo> = None;
		let mut qmc_deactivation: Option<QmcDeactivation> = None;
		let mut ue_slice_maximum_bit_rate_list: Option<UeSliceMaximumBitRateList> = None;
		...
		for _ in 0..num_ies {
			...
			match id {
				...
				326 => time_sync_assistance_info = Some(TimeSyncAssistanceInfo::decode(data)?),
				328 => qmc_config_info = Some(QmcConfigInfo::decode(data)?),
				329 => qmc_deactivation = Some(QmcDeactivation::decode(data)?),
				335 => {
					ue_slice_maximum_bit_rate_list = Some(UeSliceMaximumBitRateList::decode(data)?)
				}
				359 => {
	...
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		for _ in 0..num_ies {
			...
			match id {
				...
				223 => {
					eutra_paginge_drx_information = Some(EutraPagingeDrxInformation::decode(data)?)
				}
				222 => c_emode_brestricted = Some(CEmodeBrestricted::decode(data)?),
				332 => nr_paginge_drx_information = Some(NrPagingeDrxInformation::decode(data)?),
				342 => paging_cause = Some(PagingCause::decode(data)?),
				344 => {
...
pub struct BroadcastSessionSetupRequest {
	...
	pub mbs_session_setup_request_transfer: Vec<u8>,
}
...
impl BroadcastSessionSetupRequest {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_setup_request_transfer: Option<Vec<u8>> = None;
...
impl BroadcastSessionSetupResponse {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_session_setup_response_transfer: Option<Vec<u8>> = None;
		let mut criticality_diagnostics: Option<CriticalityDiagnostics> = None;
		...
		for _ in 0..num_ies {
			...
			match id {
				299 => mbs_session_id = Some(MbsSessionId::decode(data)?),
				316 => {
					mbs_session_setup_response_transfer =
						Some(decode::decode_octetstring(data, None, None, false)?)
				}
				19 => criticality_diagnostics = Some(CriticalityDiagnostics::decode(data)?),
				x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
...
impl BroadcastSessionSetupFailure {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_session_setup_failure_transfer: Option<Vec<u8>> = None;
		let mut cause: Option<Cause> = None;
		let mut criticality_diagnostics: Option<CriticalityDiagnostics> = None;
...
pub struct BroadcastSessionModificationRequest {
	...
	pub mbs_session_modification_request_transfer: Option<Vec<u8>>,
}
...
impl BroadcastSessionModificationRequest {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_service_area: Option<MbsServiceArea> = None;
		let mut mbs_session_modification_request_transfer: Option<Vec<u8>> = None;
...
impl BroadcastSessionModificationResponse {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_session_modification_response_transfer: Option<Vec<u8>> = None;
		let mut criticality_diagnostics: Option<CriticalityDiagnostics> = None;
		...
		for _ in 0..num_ies {
			...
			match id {
				299 => mbs_session_id = Some(MbsSessionId::decode(data)?),
				350 => {
					mbs_session_modification_response_transfer =
						Some(decode::decode_octetstring(data, None, None, false)?)
				}
				19 => criticality_diagnostics = Some(CriticalityDiagnostics::decode(data)?),
				x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
...
impl BroadcastSessionModificationFailure {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_session_modification_failure_transfer: Option<Vec<u8>> = None;
		let mut cause: Option<Cause> = None;
		let mut criticality_diagnostics: Option<CriticalityDiagnostics> = None;
...
impl BroadcastSessionReleaseResponse {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_session_release_response_transfer: Option<Vec<u8>> = None;
		let mut criticality_diagnostics: Option<CriticalityDiagnostics> = None;
		...
		for _ in 0..num_ies {
			...
			match id {
				299 => mbs_session_id = Some(MbsSessionId::decode(data)?),
				358 => {
					mbs_session_release_response_transfer =
						Some(decode::decode_octetstring(data, None, None, false)?)
				}
				19 => criticality_diagnostics = Some(CriticalityDiagnostics::decode(data)?),
				x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
...
pub struct DistributionSetupRequest {
	...
	pub mbs_distribution_setup_request_transfer: Vec<u8>,
}
...
impl DistributionSetupRequest {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_area_session_id: Option<MbsAreaSessionId> = None;
		let mut mbs_distribution_setup_request_transfer: Option<Vec<u8>> = None;
...
pub struct DistributionSetupResponse {
	pub mbs_session_id: MbsSessionId,
	pub mbs_area_session_id: Option<MbsAreaSessionId>,
	pub mbs_distribution_setup_response_transfer: Vec<u8>,
	pub criticality_diagnostics: Option<CriticalityDiagnostics>,
}
...
impl DistributionSetupResponse {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_area_session_id: Option<MbsAreaSessionId> = None;
		let mut mbs_distribution_setup_response_transfer: Option<Vec<u8>> = None;
		let mut criticality_diagnostics: Option<CriticalityDiagnostics> = None;
		...
		for _ in 0..num_ies {
			...
			match id {
				...
				295 => mbs_area_session_id = Some(MbsAreaSessionId::decode(data)?),
				302 => {
					mbs_distribution_setup_response_transfer =
						Some(decode::decode_octetstring(data, None, None, false)?)
				}
				19 => criticality_diagnostics = Some(CriticalityDiagnostics::decode(data)?),
				x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
...
pub struct DistributionSetupFailure {
	pub mbs_session_id: MbsSessionId,
	pub mbs_area_session_id: Option<MbsAreaSessionId>,
	pub mbs_distribution_setup_unsuccessful_transfer: Vec<u8>,
	pub cause: Cause,
	pub criticality_diagnostics: Option<CriticalityDiagnostics>,
}
...
impl DistributionSetupFailure {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_area_session_id: Option<MbsAreaSessionId> = None;
		let mut mbs_distribution_setup_unsuccessful_transfer: Option<Vec<u8>> = None;
		let mut cause: Option<Cause> = None;
		let mut criticality_diagnostics: Option<CriticalityDiagnostics> = None;
...
pub struct DistributionReleaseRequest {
	pub mbs_session_id: MbsSessionId,
	pub mbs_area_session_id: Option<MbsAreaSessionId>,
	pub mbs_distribution_release_request_transfer: Vec<u8>,
	pub cause: Cause,
}
...
impl DistributionReleaseRequest {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_area_session_id: Option<MbsAreaSessionId> = None;
		let mut mbs_distribution_release_request_transfer: Option<Vec<u8>> = None;
		let mut cause: Option<Cause> = None;
...
impl MulticastSessionActivationRequest {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut multicast_session_activation_request_transfer: Option<Vec<u8>> = None;
...
impl MulticastSessionDeactivationRequest {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut multicast_session_deactivation_request_transfer: Option<Vec<u8>> = None;
...
pub struct MulticastSessionUpdateRequest {
	pub mbs_session_id: MbsSessionId,
	pub mbs_area_session_id: Option<MbsAreaSessionId>,
	pub multicast_session_update_request_transfer: Vec<u8>,
}
...
impl MulticastSessionUpdateRequest {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_area_session_id: Option<MbsAreaSessionId> = None;
		let mut multicast_session_update_request_transfer: Option<Vec<u8>> = None;
...
pub struct MulticastGroupPaging {
	pub mbs_session_id: MbsSessionId,
	pub mbs_service_area: Option<MbsServiceArea>,
	pub multicast_group_paging_area_list: MulticastGroupPagingAreaList,
}
...
impl MulticastGroupPaging {
	fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
		...
		let mut mbs_session_id: Option<MbsSessionId> = None;
		let mut mbs_service_area: Option<MbsServiceArea> = None;
		let mut multicast_group_paging_area_list: Option<MulticastGroupPagingAreaList> = None;
